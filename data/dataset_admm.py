...
from .scene_depth_admm import SceneDepthEstimatorADMM
...
class UIEDataset(Dataset):
    def __init__(self, dataroot, resolution=256, split='train', data_len=-1):
        ...
        self.depth_prior = SceneDepthEstimatorADMM()
    ...
    def __getitem__(self, index):
        ...
        with torch.no_grad():
            depth = self.depth_prior(input_01.unsqueeze(0)).squeeze(0)  # [1, H, W], [0,1]
